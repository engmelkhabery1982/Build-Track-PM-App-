...
export function ResourceCapacityBoard({
  ...
  return <div className="mx-auto w-full max-w-[1600px] space-y-5 p-5">
    <div className="flex flex-wrap items-start justify-between gap-3">
      ...
      <div className="flex flex-wrap gap-2"><button onClick={() => onNavigate('resourceLeveling')} className="rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-2 text-sm font-semibold text-indigo-700 hover:bg-indigo-100">Leveling Register (F7) <ArrowRight className="ml-1 inline" size={14}/></button><button onClick={() => onNavigate('resourceAssignments')} className="rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50">Assignments <ArrowRight className="ml-1 inline" size={14}/></button><button onClick={() => onNavigate('schedule')} className="rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50">Schedule <ArrowRight className="ml-1 inline" size={14}/></button></div>
    </div>
