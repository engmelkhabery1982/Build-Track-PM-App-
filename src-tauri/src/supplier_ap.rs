//! Atomic supplier AP lifecycle.  The desktop UI never becomes the financial
//! source of truth: approval, settlement and reversal commit as one SQLite transaction.
