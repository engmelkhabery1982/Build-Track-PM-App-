...
> تنفيذ F1–G3؛ تُحفظ الأجزاء الصحيحة وتُغلق فجواتها عبر W01–W13، ثم W14–W90.
> لا يمنح الوكيل نفسه 8/10؛ Codex وحده يغلق البوابة بعد القبول المحلي.
> F1/W01 وF2/W02 مصنفتان `PARTIAL — 4/10 — NOT ACCEPTED`. المواصفة الحاكمة
> التفصيلية هي ملفات W01/W02 وفجوات `W01-G01..G10` و`W02-G01..G10` داخل الخطة؛
> نجاح regression أو وجود المسودة لا يسمح بتجاوز أي منهما.
