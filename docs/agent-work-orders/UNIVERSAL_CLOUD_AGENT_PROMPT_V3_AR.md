# الرسالة الموحدة V3 — مجمدة / مرجع تاريخي فقط

> **لا تنفذ هذه الرسالة.** تم تجميد W07–W90 واستبدالها بـ
> `UNIVERSAL_STABILIZATION_AGENT_PROMPT_V4_AR.md` وخطة ORF. ارجع دائمًا إلى
> `ACTIVE.UNIFIED_PROMPT` ولا تستخدم قائمة الميزات القديمة.

# الأرشيف السابق — جلسة واحدة وقائمة ميزات مفتوحة
