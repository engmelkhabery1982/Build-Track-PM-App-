...
ACCEPTED_ATTESTATION_SHA256=7D3D8DA5B7938DE8564404C74E0231FA3BBC1DBB399F1362CCDDB64E90906B3D
CLOUD_BASE_BRANCH=main
DELIVERY_BRANCH=main
WORK_BRANCH_PATTERN=^(main|arena/[A-Za-z0-9._-]+)$
PREFLIGHT_COMMAND=node tools/agent-preflight.mjs
DELIVERY_GATE_COMMAND=node tools/agent-delivery-gate.mjs --start-head <START_HEAD> --feature <Wxx>
CURRENT_FEATURE=W04
