...
CURRENT_STATUS=OPEN_WAITING_FOR_USER_COMMAND
CODEX_REVIEW_STATUS=W05_ACCEPTED_8_OF_10_W06_OPEN
...
- W06 مفتوحة، لكن لا تبدأ إلا عندما يرسل المستخدم «ابدأ الميزة التالية». لا تنتظر قبول Codex.
- لا تعدل W05 أو ملفات السلطة؛ نفذ W06 فقط وفق F6 وخطتها.
