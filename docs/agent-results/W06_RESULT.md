...
Status: CORRECTION ROUND 4 REQUIRED — NOT CLOSED — NOT YET 8/10
...
W06-C02=FAIL (SPI/CPI are always unavailable and Data Quality is still fabricated as zero)
W06-C03=FAIL (`cutoff_date` is unused and source queries have no Data-Date predicate)
...
W06-C07=PARTIAL (Dashboard/ReportPack read snapshots; Card/Cockpit still recalculate)
W06-C08=FAIL (Rust workflow tests execute but fail 0/2 with SQLite code 14)
...
- Targeted Node gate passes 15/15. Rust tests fail 0/2 and the backend still lacks authentic,
  Data-Date-filtered SPI/CPI/Data Quality calculations. See the Codex review before continuing.
